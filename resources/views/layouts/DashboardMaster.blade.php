...
<head>
    ...
    <link rel="shortcut icon" href="/assets/mazer/compiled/svg/favicon.svg" type="image/x-icon">
...
<body>
    ...
    <div class="sidebar-header position-relative">
        <div class="d-flex justify-content-between align-items-center">
            <div class="logo">
                <a href="/dashboard">Digitalisasi</a>
            </div>
    ...
    <div class="sidebar-menu">
        <ul class="menu">
            ...
            <li class="sidebar-item  ">
                <a href="{{ route('user_index') }}" class='sidebar-link'>
            ...
            <li class="sidebar-item  ">
                <a href="{{ route('item_index') }}" class='sidebar-link'>
                            ...
                            <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable"
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalCenterTitle">Yakin ingin logout?
                                        </h5>
                                    ...
                                    <div class="modal-body">
                                        <p>
                                            Jika logout anda akan diminta memasukan username dan password kembali saat ingin mengakses dashboard ini!
                                        </p>
                                    </div>
...
<footer>
    <div class="footer clearfix mb-0 text-muted">
        <div class="float-start">
            <p>2024 &copy; Digitalisasi</p>
        </div>
        <div class="float-end">
            <p>Digitalisasi Gedung BRIN</p>
        </div>
    </div>
</footer>
        </div>
